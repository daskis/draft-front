...
import {HTag, Input, PTag, Radio, Select} from "@/components";
        ...
        <main className={cls.wrapper}>
            ...
            <section>
                ...
                >
                    ...
                    <div className={cls.formLine}>
                        <HTag
                            tip={"tesdsafgegartrвфывф gssssssssssst"}
                            className={cls.formTitle}>
                ...
                <div className={cls.form}>
                    ...
                    <div className={cls.formLine}>
                        <div className={cls.titleWrapper}>
                            <HTag
                                tip={"test"}
                                className={cls.formTitle}>
                                Архитектурно-художественная и эстетическая выразительность застройки и окружающей среда
                            </HTag>
                            <PTag>
                                оцените экспетрно от 1 до 5
                            </PTag>
                    ...
                    <div className={cls.formLine}>
                        <HTag
                            tip={"test"}
                            className={cls.formTitle}>
                            Подлинность застройки <br/> (способность отличительных характеристик адекватно и достоверно
                            выражать его ценность, форма и замысел, материалы и вещества, местоположение и окружение)
                        </HTag>
                    ...
                    <div className={cls.formLine}>
                        <HTag
                            ...
                            className={cls.formTitle}
                        >
                            Целостность застройки <br/> (мера единства и неповрежденности объекта и его окружения)
                        </HTag>
                        <div className={cls.radioWrapper}>
                            <Radio
                                id="integrity1"
                ...
                <div className={cn(cls.form, cls.thirdForm)}>
                    ...
                    <div className={cn(cls.formLine, cls.formColumn)}>
                        ...
                        <PTag>
                            ...
                            коммуникационный след территории, его температурную составляющую и интенсивность в глазах
                            опрашиваемого
                        </PTag>
                    </div>
                    <div className={cn(cls.formLine, cls.formColumn)}>
                        ...
                        <PTag className={cls.clarified}>
                            Более 80% опрошенных в боте четко формулируют локальные особенности места, выраженные в
                    ...
                    <div className={cn(cls.formLine, cls.formColumn)}>
                        ...
                        <PTag>
                            Ассоциируете ли вы себя с тем или иным объектом в городе? Возможно территорией или событием?
                        </PTag>
                    </div>
                    <div className={cn(cls.formLine, cls.formColumn)}>
                        <HTag className={cn(cls.formTitle, cls.titleTip)}>
                        ...
                        <PTag className={cls.clarified}>
                            Более 80% опрошенных имеют стойкую привязанность к рассматриваемой территории, поделились
                            историями и воспоминаниями. Конкретные ассоциации можно посмотреть в отчете-расшифровке
                            опроса.
                        </PTag>
                    </div>
                    ...
                    <div className={cn(cls.formLine, cls.formColumn)}>
                        ...
                        <PTag className={cls.clarified}>
                            ОТ 40 до 60% опрошенных описывают город как креативный и они или их знакомые вовлечены в
                            культурную жизнь. Обсуждаемая территория, скорее всего, вносит опосредованный вклад в
